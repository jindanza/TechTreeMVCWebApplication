...
namespace TechTreeMVCWebApplication.Controllers
{
    ...
    public class CategoriesToUserController : Controller
    {
        ...
        public async Task<IActionResult> Index(string[] categoriesSelected)
        {
            ...
            List<UserCategory> userCategoriesToAdd = await GetCategoriesToAddForUser(categoriesSelected, userId);
        ...
        private async Task<List<UserCategory>> GetCategoriesToAddForUser(string[] categoriesSelected, string userId)
        {
