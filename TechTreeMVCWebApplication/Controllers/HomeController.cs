...
namespace TechTreeMVCWebApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        private IEnumerable<GroupedCategoryItemsByCategoryModel> GetGroupedCategoryItemsByCategory(IEnumerable<CategoryItemDetailsModel> categoryItemdDetailsModel)
        {
            return from item in categoryItemdDetailsModel
